...
struct carstruct{
    ...
    event statusevent(string itemname, uint itemprice, uint itemquantity, uint itemuniqueid, uint itemid, uint itemtrackingstatus, address itemowner);
    event carevent(string itemname, uint itemprice, uint itemquantity, uint itemuniqueid, uint itemnumber, address itemowner,string carname, string carmodel, uint carprice, uint caruniqueid);
    ...
    function itemcreation(string name, uint price, uint quantity, uint itemid) public{
        ...
        emit statusevent(inventorymapping[itemid].itemname, inventorymapping[itemid].itemprice, inventorymapping[itemid].itemquantity,inventorymapping[itemid].itemuniqueid ,inventorymapping[itemid].itemnumber, uint(status.itemcreatedbymanufacturer),inventorymapping[itemid].itemowner);
    }
    
    function batterycreation(string name, uint price, uint quantity, uint itemid) public{
        require(msg.sender == manufacturer,"Only the manufacturer can create the item");
        ...
        emit statusevent(batterymapping[itemid].itemname, batterymapping[itemid].itemprice, batterymapping[itemid].itemquantity,batterymapping[itemid].itemuniqueid ,batterymapping[itemid].itemnumber, uint(status.itemcreatedbymanufacturer),batterymapping[itemid].itemowner);
    }
    ...
    function buyandpayitem(uint itemid) public payable{
        ...
        inventorymapping[itemid].itemowner = msg.sender;
        inventorymapping[itemid].ownerarray.push(msg.sender);
        emit statusevent(inventorymapping[itemid].itemname, inventorymapping[itemid].itemprice, inventorymapping[itemid].itemquantity,inventorymapping[itemid].itemuniqueid ,inventorymapping[itemid].itemnumber, uint(status.boughtandpaidbyassembler),inventorymapping[itemid].itemowner);
    }
    ...
    function buyandpaybattery(uint itemid) public payable{
        ...
        batterymapping[itemid].itemowner = msg.sender;
        batterymapping[itemid].ownerarray.push(msg.sender);
        emit statusevent(batterymapping[itemid].itemname, batterymapping[itemid].itemprice, batterymapping[itemid].itemquantity,batterymapping[itemid].itemuniqueid ,batterymapping[itemid].itemnumber, uint(status.boughtandpaidbyassembler),batterymapping[itemid].itemowner);
    }
    ...
    function enginedeliveredbymanufacturer(uint itemid) public{
        ...
        emit statusevent(inventorymapping[itemid].itemname, inventorymapping[itemid].itemprice, inventorymapping[itemid].itemquantity,inventorymapping[itemid].itemuniqueid ,inventorymapping[itemid].itemnumber, uint(status.outfordeliverybymanufacturer),inventorymapping[itemid].itemowner);
    }
    ...
    function batterydeliveredbymanufacturer(uint itemid) public{
        ...
        emit statusevent(batterymapping[itemid].itemname, batterymapping[itemid].itemprice, batterymapping[itemid].itemquantity,batterymapping[itemid].itemuniqueid ,batterymapping[itemid].itemnumber, uint(status.outfordeliverybymanufacturer),batterymapping[itemid].itemowner);
    }
    
    function itemownersdetails(uint num) public view returns(address[]){
        return inventorymapping[num].ownerarray;
    }
    
    function batteryownersdetails(uint num) public view returns(address[]){
    ...
    function registercar(string carname, string carmodel, uint carprice, uint carid, uint itemid) public  {
        ...
        carmapping[carid].battery.itemname = batterymapping[itemid].itemname ;
        carmapping[carid].battery.itemprice = batterymapping[itemid].itemprice;
        carmapping[carid].battery.itemquantity = batterymapping[itemid].itemquantity;
        carmapping[carid].battery.itemuniqueid = batterymapping[itemid].itemuniqueid ;
        carmapping[carid].battery.itemnumber = batterymapping[itemid].itemnumber;
        carmapping[carid].battery.itemowner = batterymapping[itemid].itemowner;
        carmapping[carid].battery.itemstatus = batterymapping[itemid].itemstatus;
        carmapping[carid].battery.itempossesdby = batterymapping[itemid].itempossesdby;
        ...
        emit carevent(carmapping[carid].engine.itemname,carmapping[carid].engine.itemprice,carmapping[carid].engine.itemquantity,carmapping[carid].engine.itemuniqueid,carmapping[carid].engine.itemnumber,carmapping[carid].engine.itemowner,carmapping[carid].carname, carmapping[carid].carmodel,carmapping[carid].carprice,carmapping[carid].caruniqueid);
    ...
    // function buyusedcar(uint carid) public payable{
    //     require(carmapping[carid].carprice == msg.value, "car price not matched");
    //     require(carmapping[carid].carstatus == carstatus.readyforsale,"The car is not yet readyforsale");
    ...
    function carownershistory(uint carid) public view returns(address[]){
        return carmapping[carid].carownerarray;
    }
    
    function cardetails(uint carid) public view returns (carstruct){
    ...
    function withdrawpaymentfromcontract() public {
        ...
        manufacturer.transfer(address(this).balance);
    }
