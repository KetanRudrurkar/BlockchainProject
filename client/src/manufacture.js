...
class manufacture extends Component {
    ...
    render() { 
        ...
        return (  
            ...
            Engine id (Unique): <input type="text" id = "engine" name="engineid" value={this.props.engine.engineid} onChange={this.props.typinginput} />
            ...
            <strong><h3>Create Battery</h3></strong>
             Battery Name : <input type="text" id = "battery" name="batteryname" value={this.props.battery.batteryname} onChange={this.props.typinginput} />
            Battery Price (Wei) : <input type="text" id = "battery" name="batteryprice" value={this.props.battery.batteryprice} onChange={this.props.typinginput} />
            Battery Quantity: <input type="text" id = "battery" name="batteryquantity" value={this.props.battery.batteryquantity} onChange={this.props.typinginput} />
            Battery id (Unique): <input type="text" id = "battery" name="batteryid" value={this.props.battery.batteryid} onChange={this.props.typinginput} />
